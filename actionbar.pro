...
UBUNTU_TRANSLATION_DOMAIN="actionbar.liu-xiao-guo"
...
aptest.commands = bash $$PWD/actionbar/tests/autopilot/run
aptest.depends  = sub-actionbar

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/actionbar/tests/unit 
unittest.depends  = sub-actionbar
